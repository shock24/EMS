 ...
 * Generated at: 2021-08-07 10:42:14 UTC
...
public final class ShowDepartment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.homeinsurance.dao.RegulationDao");
    _jspx_imports_classes.add("com.homeinsurance.entities.NormalUser");
    _jspx_imports_classes.add("com.homeinsurance.entities.Regulation");
...
List<Regulation> allRegulations = rDao.getAllRegulations(deptId);
      ...
      out.write("<script async defer crossorigin=\"anonymous\" src=\"https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v11.0\" nonce=\"OPwUVGB5\"></script>\r\n");
      out.write("\t\r\n");
      out.write("\t");
      out.write("\r\n");
      out.write("\r\n");
 ...
 if(adminUser == null && normalUser == null)
      ...
      out.write("\t\t<div class=\"container text-end my-3\">\r\n");
      out.write("\t\t");
if(request.getSession().getAttribute("userType").equals("admin")){ 
      out.write("\r\n");
      out.write("\t\t\t<a type=\"button\" class=\"btn btn-primary mx-3\" href=\"admin.jsp\">Back to departments</a>\r\n");
      out.write("\t\t");
} else { 
      out.write("\r\n");
      out.write("\t\t\t<a type=\"button\" class=\"btn btn-primary mx-3\" href=\"normal.jsp\">Back to departments</a>\r\n");
      out.write("\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t");
if(request.getSession().getAttribute("userType").equals("admin")){ 
      out.write("\r\n");
      out.write("\t\t\t\t<button class=\"btn btn-primary\" data-bs-toggle=\"modal\" data-bs-target=\"#addRegulationModal\">Add Regulation</button>\r\n");
      out.write("\t\t\t ");
 }
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
...
if(request.getSession().getAttribute("userType").equals("admin")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-outline-primary my-2\" data-bs-toggle=\"modal\" data-bs-target=\"#editRegulation");
      out.print( r.getRegId() );
      out.write("\">Edit</button>\r\n");
      out.write("\t\t\t\t\t\t\t<form action=\"DeleteRegulationServlet\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" name=\"deleteReg\" class=\"btn btn-outline-warning my-2\" value=\"");
      out.print( r.getRegId());
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<!-- Modal -->\r\n");
      out.write("\t\t\t\t<div class=\"modal fade\" id=\"editRegulation");
      out.print( r.getRegId() );
      ...
      out.write("\t\t\t\t        <form action=\"UpdateRegulationServlet\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t  <div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t\t\t    <input type=\"hidden\" name=\"regId\" value=\"");
      out.print( r.getRegId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t    <input type=\"hidden\" name=\"deptId\" value=\"");
      out.print( r.getDepartment().getDeptId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t    <input type=\"text\" class=\"form-control\" id=\"regTitle\" aria-describedby=\"emailHelp\" value=\"");
      out.print( r.getRegTitle() );
      out.write("\" name=\"regTitle\">\r\n");
      out.write("\t\t\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t\t  <div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t\t\t    <textarea class=\"form-control\" name=\"regDesc\">");
      out.print( r.getDescription() );
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t  </div>\r\n");
      ...
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"fb-comments\" data-href=\"http://localhost:9494/EMS/ShowDepartment.jsp?deptId=8\" data-width=\"\" data-numposts=\"5\"></div>\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t </div>\r\n");
      out.write("\t \r\n");
      out.write("\t <!-- Add Regulation Modal -->\r\n");
      out.write("\t\t<div class=\"modal fade\" id=\"addRegulationModal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t  <div class=\"modal-dialog\">\r\n");
      out.write("\t\t    <div class=\"modal-content\">\r\n");
      out.write("\t\t      <div class=\"modal-header\">\r\n");
      out.write("\t\t        <h5 class=\"modal-title\" id=\"exampleModalLabel\">Add Regulation</h5>\r\n");
      out.write("\t\t        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n");
      out.write("\t\t      </div>\r\n");
      out.write("\t\t      <div class=\"modal-body\">\r\n");
      out.write("\t\t      <form action=\"AddRegulationServlet\" method=\"post\">\r\n");
      out.write("\t\t\t\t  <div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t  \t<input type=\"hidden\" name=\"deptId\" value=\"");
      out.print( deptId );
      out.write("\">\r\n");
      out.write("\t\t\t\t    <input type=\"text\" class=\"form-control\" id=\"regTitle\" aria-describedby=\"regTitle\" name=\"regTitle\" placeholder=\"Enter Title\" required>\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t  <div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t    <textarea style=\"height:150px\" class=\"form-control\" name=\"regDesc\" placeholder=\"Enter Regulation Details\" required></textarea>\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t  \r\n");
